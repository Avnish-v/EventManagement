...
const Booking = () => {
  ...
  const calculateTotalPrice = () => {
    let totalPrice =
      parseInt(state?.price || 0) + person * (foodType === "veg" ? 400 : 500);
    setState(totalPrice);
  };
  useEffect(() => {
    calculateTotalPrice();
  ...
  return (
    <div className="m-24 bg-[#000000]  rounded-lg p-6">
      ...
      <p className="text-center mt-2 text-[red]">
        (Note-:Food Excluded for 500/- Non-veg and 400/- veg per-person and 500
        for both)
      </p>
      <div className="flex justify-center mt-4 ">
        <form className="text-secondary-50 mt-4 flex flex-col items-center w-[40%] border-2 border-[white] rounded-lg p-6">
          ...
          <div className="flex justify-center">
            <button
              className="h-10  font-bold bg-[#00A885] rounded-md mt-6 w-[200px]"
